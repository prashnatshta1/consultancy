...
export default function IndonesiaPage() {
  const institutions = [
    { name: "Deakin University Lancaster University Indonesia", logo: "https://www.navitas.com/wp-content/uploads/2024/02/DLI-Logo-257x193px.jpg", url: "https://www.dli.id" }
  ];
  ...
  return (
    <>
      ...
      <main id="main">
        {/* Hero Section */}
        <section className="relative h-[500px] bg-cover bg-center bg-no-repeat" style={{backgroundImage: "url('https://www.navitas.com/wp-content/uploads/2024/02/indonesia-bridge-1600x500px.jpg')"}}>
        ...
        <div className="container mx-auto px-4 pt-3">
          <nav aria-label="Breadcrumb">
            <ol className="flex items-center space-x-2 text-sm">
              ...
              <li className="text-gray-400">/</li>
              <li className="text-gray-900 font-medium">Indonesia</li>
            </ol>
          </nav>
        </div>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-bold text-center mb-12">Our campuses in Indonesia</h2>
